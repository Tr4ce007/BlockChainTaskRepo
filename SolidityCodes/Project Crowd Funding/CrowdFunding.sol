...
//contributors[msg.sender]=100
    ...
    function sendEth() public payable{
        ...
        require(msg.value >=minimumContribution,"Minimum Contribution is 
not met");
    ...
    function refund() public{
        require(block.timestamp>deadline && raisedAmount<target,"You are 
...
function");
    ...
    function createRequests(string memory _description,address payable 
_recipient,uint _value) public onlyManger{
...
completed");
        require(thisRequest.noOfVoters > noOfContributors/2,"Majority does 
not support");
